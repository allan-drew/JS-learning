...
let a = 10; // TypeScript inferindo o tipo number para a variável
//a = "olá"; // Type 'string' is not assignable to type 'number'

// Explicitly specifying the type
let b: number = 12; // sem inferir
...
let agradecimento = "Muito obrigado!"; // Typescript knows that agradecimento is a type string


// telling TypeScript that jogador is string and date should be a Date object
function boasVindas(jogador: string, date: Date) {
    console.log(`Bem-Vindo ao Fla, ${jogador}! Hoje é ${date.toDateString()}!`);
}
